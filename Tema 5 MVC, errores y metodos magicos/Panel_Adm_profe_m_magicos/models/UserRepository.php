...
class UserRepository{
    ...
    public static function addFriend($id){
        $db=Conectar::conexion();
        $result=$db->query("insert into friends values(".$_SESSION['user']->id.",".$id.")");
    }

    public static function delFriend($id){
        $db=Conectar::conexion();
        $result=$db->query("delete from friends where (idUser1 = ".$_SESSION['user']->id." 
        and idUser2 = ".$id.") or (idUser2 = ".$_SESSION['user']->id." 
        and idUser1 = ".$id.")");
    }
}
?>